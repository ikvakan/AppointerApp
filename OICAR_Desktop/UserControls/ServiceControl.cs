...
namespace OICAR_Desktop.UserControls
{
    ...
    public partial class ServiceControl : UserControl
    {
        ...
        {
            //HelperMethods.ShowControl(new AddServiceControl(), pnlContent);
            OpenFormHelper.OpenChildForm(new AddServiceForm(), pnlContent);
        }
        ...
        private void btnDeleteServiceType_Click(object sender, EventArgs e)
        {
            ...
            var appointments = uow.Apponitments.GetAppointmentsByService(services);
        ...
        {
            //var serviceType = lbServices.SelectedItem as Service_Type;
            //PopulateGrid(serviceType.IdServiceType);

            HelperMethods.ShowControl(new ServiceControl(), pnlContent);
        }
    }
