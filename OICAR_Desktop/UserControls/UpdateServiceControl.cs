...
namespace OICAR_Desktop.UserControls
{
    public partial class UpdateServiceControl : UserControl
    {
       ...
       // private Panel _pnlContent;
        ...
        public UpdateServiceControl(Service service, Service_Type service_Type)
        {
            // _pnlContent = content;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Form form = pnlContent.FindForm();
                MessageBox.Show(form.Name);
                //OpenFormHelper f = new OpenFormHelper();
                //f.OpenChildForm(new ClientForm(pnlContent), pnlContent);
